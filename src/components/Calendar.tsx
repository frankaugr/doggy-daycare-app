...
import { Dog, ServiceType, AttendanceEntry, RecurringSchedule, AttendanceType } from '../App';
...
export default function Calendar({ dogs }: CalendarProps) {
  ...
  useEffect(() => {
    if (import.meta.env.DEV) {
      ...
      return () => {
        delete (window as any).clearAutoGeneratedAttendance;
      };
    }
  }, [clearAutoGeneratedAttendance]);
      ...
      for (const targetDog of dogsToUpdate) {
        ...
        if (serviceType === ServiceType.Daycare) {
          ...
          await invoke('update_attendance_type', {
            date: dateStr,
            dogId: targetDog.id,
            attendanceType: attending ? AttendanceType.FullDay : AttendanceType.NotAttending,
          });
